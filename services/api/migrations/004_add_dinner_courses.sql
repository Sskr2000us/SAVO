...
-- Add dinner_courses column to household_profiles
ALTER TABLE public.household_profiles
ADD COLUMN IF NOT EXISTS dinner_courses INTEGER DEFAULT 2;

-- Add constraint to ensure valid range (1-5 courses)
ALTER TABLE public.household_profiles
